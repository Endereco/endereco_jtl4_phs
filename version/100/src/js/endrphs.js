...
if (typeof window !== 'undefined') {
  ...
  window.calcEnrdPhs = (event = undefined) => {
    ...
    if (isDeliveryVisible) {
      ...
      if ($lafixPhoneField !== null && $lafixPhoneField.value === '' && $rafixPhoneField !== null && ($rafixPhoneField.value !== '')) {
        $lafixPhoneField.value = $rafixPhoneField.value;
        $rafixPhoneField.value = '';
      }
      if ($lamobPhoneField !== null && $lamobPhoneField.value === '' && $ramobPhoneField !== null && $ramobPhoneField.value !== '') {
        $lamobPhoneField.value = $ramobPhoneField.value;
        $ramobPhoneField.value = '';
      }
    } else {
      // Copy values to invoice.
      if ($rafixPhoneField !== null && $rafixPhoneField.value === '' && $lafixPhoneField !== null && $lafixPhoneField.value !== '') {
        $rafixPhoneField.value = $lafixPhoneField.value;
        $lafixPhoneField.value = '';
      }
      if ($ramobPhoneField !== null && $ramobPhoneField.value === '' && $lamobPhoneField !== null && $lamobPhoneField.value !== '') {
